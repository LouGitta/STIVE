...
Public Class modifierProduit
    Public Class ApiConstants
        Public Const ApiBaseUrl As String = "localhost/stive/api/"
    End Class
    ...
    Private Function ObtenirProduitDeApi(recordId As Integer) As Produit
        Dim apiUrl As String = $"localhost/stive/api/produit/{recordId}"
    ...
    Private Function MettreAJourProduitDansApi(nouvellesDonnees As Produit) As Boolean
        Dim apiUrl As String = $"localhost/stive/api/produit/{_recordId}"
        Using client As New HttpClient()
